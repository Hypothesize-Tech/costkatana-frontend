...
export const OptimizedPromptDisplay: React.FC<OptimizedPromptDisplayProps> = ({
                    ...
                    <span key={index}>
                        {inlineParts.map((inlinePart, inlineIndex) => {
                            if (inlinePart.startsWith('`') && inlinePart.endsWith('`')) {
                                ...
                                return (
                                    <code key={inlineIndex} className="bg-gray-100 text-gray-800 px-1 py-0.5 rounded text-sm font-mono">
                                        {code}
                                    </code>
                                );
                            } else {
    ...
    return (
        <div className={`bg-gray-50 rounded-md border p-3 ${maxHeight} overflow-y-auto ${className}`}>
