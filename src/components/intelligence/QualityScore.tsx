...
interface QualityScoreProps {
    ...
    onFeedback?: (feedback: { isAcceptable: boolean; rating?: number; comment?: string }) => void;
}
            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                    <div className="text-center">
                        <div className={`text-3xl font-bold ${getScoreColor(qualityData.optimizedScore)}`}>
                    ...
                    {qualityData.originalScore && qualityData.qualityRetention && (
                        <>
                            ...
                            <div className="text-center">
                                <div className={`text-2xl font-semibold ${getScoreColor(qualityData.qualityRetention)}`}>
                ...
                <div className="flex items-center space-x-3">
                    <div className="text-right">
                        <div className="flex items-center space-x-1 text-green-600">
                            ...
                            <span className="font-semibold">${qualityData.costSavings.amount.toFixed(2)}</span>
                        </div>
                        <div className="text-xs text-gray-500">{qualityData.costSavings.percentage}% saved</div>
                    </div>
                </div>
            </div>
            ...
            {showDetails && qualityData.criteria && (
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        {renderCriteriaBar('Completeness', qualityData.criteria.completeness)}
                    ...
                    <div className="flex items-center space-x-2">
                        {[1, 2, 3, 4, 5].map((rating) => (
                            <button
                                ...
                                className={`p-1 rounded ${userRating >= rating
                                        ? 'text-yellow-500'
