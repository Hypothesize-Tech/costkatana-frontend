  ...
  if (error) {
    return (
      <div className="space-y-6">
        ...
        <div
          className={`p-4 rounded-md ${authError ? "bg-yellow-50 border border-yellow-200" : "bg-red-50 border border-red-200"}`}
        >
          <div className="flex">
            <div className="flex-shrink-0">
              <svg
                className={`w-5 h-5 ${authError ? "text-yellow-400" : "text-red-400"}`}
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
            ...
            <div className="ml-3">
              <h3
                className={`text-sm font-medium ${authError ? "text-yellow-800" : "text-red-800"}`}
              >
                {authError ? "Authentication Required" : "Error Loading Data"}
              </h3>
              <p
                className={`mt-1 text-sm ${authError ? "text-yellow-700" : "text-red-700"}`}
              >
                {error}
              </p>
            </div>
