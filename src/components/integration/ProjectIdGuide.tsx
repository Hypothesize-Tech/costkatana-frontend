...
export const ProjectIdGuide: React.FC = () => {
    ...
    const generateProjectUsageExample = (projectId: string, projectName: string) => {
        ...
        <div className="space-y-6">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    Project IDs help you organize and track AI usage across different projects, teams, and departments.
                </p>
            </div>
            ...
            <div>
                ...
                <div className="space-y-3">
                    {projects?.map(project => (
                        <div key={project._id} className="border border-gray-200 dark:border-gray-700 rounded-lg">
                            <div className="p-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        onClick={() => copyToClipboard(project._id, `project-${project._id}`)}
                                    ...
                                    >
                                        ...
                                        {copied === `project-${project._id}` ? 'Copied!' : 'Copy ID'}
                                    </button>
                                </div>
                                <div className="mt-2">
                            ...
                            <div className="p-4">
                                ...
                                <pre className="text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900 p-3 rounded overflow-x-auto">
                                    <code>{generateProjectUsageExample(project._id, project.name)}</code>
                                </pre>
                            </div>
                        </div>
                    ))}
                    ...
                    {(!projects || projects.length === 0) && (
                        <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                            ...
                            <p className="text-sm">Create a project to get started with project-based tracking</p>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                ...
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                    <li>• Use project IDs to separate costs by team, department, or client</li>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm font-mono">
                    <div className="flex items-center justify-between bg-yellow-100 dark:bg-yellow-800 px-2 py-1 rounded">
                        ...
                        <button
                            onClick={() => copyToClipboard(`${window.location.origin}/api`, 'dashboard-url')}
