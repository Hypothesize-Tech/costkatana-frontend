            ...
            <div className="glass max-w-2xl w-full max-h-[80vh] overflow-hidden rounded-2xl shadow-2xl animate-scale-in">
                ...
                <div className="p-6">
                    <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
                        Describe the code changes you'd like to make. The changes will be applied to your deployed project and automatically redeployed.
                    </p>
                    <textarea
                        value={value}
                        onChange={(e) => onChange(e.target.value)}
                        placeholder="E.g., Change the button color to blue, add a delete confirmation dialog, fix the responsive layout on mobile..."
