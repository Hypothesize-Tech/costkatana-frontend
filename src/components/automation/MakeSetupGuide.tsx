...
interface MakeSetupGuideProps {
    connection?: AutomationConnection;
    apiKey?: string;
}

export const MakeSetupGuide: React.FC<MakeSetupGuideProps> = ({ connection, apiKey }) => {
    ...
    const steps = [
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-sm font-body text-light-text-secondary dark:text-dark-text-secondary">
                        You need an API key to authenticate webhook requests from Make.
                    </p>
        ...
        {
            id: 3,
            title: 'Set Up Make Webhook',
            content: (
                <div className="space-y-4">
                    <p className="text-sm font-body text-light-text-secondary dark:text-dark-text-secondary">
                        In your Make scenario, add an HTTP Request module to send cost data to CostKatana.
                    </p>
                    ...
                    <div className="space-y-3">
                        <div className="p-4 rounded-lg border border-primary-200/30 dark:border-primary-500/20 bg-white/50 dark:bg-dark-card/50">
                            ...
                            <ol className="list-decimal list-inside space-y-1 text-xs font-body text-light-text-secondary dark:text-dark-text-secondary">
                                <li>In Make, click <strong>+</strong> to add a new module</li>
                                <li>Search for <strong>"HTTP"</strong> or <strong>"Make an HTTP Request"</strong></li>
                                <li>Select <strong>"Make an HTTP Request"</strong> module</li>
                            </ol>
                        </div>
                        ...
                        <div className="p-4 rounded-lg border border-primary-200/30 dark:border-primary-500/20 bg-white/50 dark:bg-dark-card/50">
                            ...
                            <p className="text-xs font-body text-light-text-secondary dark:text-dark-text-secondary mb-2">
                                Use this JSON structure (map fields from your AI module):
                            </p>
  ...
  "tags": ["make"]
                        ...
                        <div className="p-4 rounded-lg border border-blue-200/30 dark:border-blue-500/20 bg-blue-50/50 dark:bg-blue-900/20">
                            <div className="flex items-start gap-2">
                                ...
                                <div className="text-xs text-blue-700 dark:text-blue-300">
                                    <strong>Tip:</strong> For multi-step scenarios, you can send a batch payload with all steps in one request. See the documentation for batch payload format.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-sm font-body text-light-text-secondary dark:text-dark-text-secondary">
                        After your Make scenario runs, view the tracked costs in CostKatana.
                    </p>
                    <div className="p-4 rounded-lg border border-primary-200/30 dark:border-primary-500/20 bg-white/50 dark:bg-dark-card/50">
                        <ol className="list-decimal list-inside space-y-2 text-sm font-body text-light-text-secondary dark:text-dark-text-secondary">
                            ...
                            <li>Check the <strong>By Workflow</strong> tab to see individual scenario costs</li>
                    ...
                    <div className="p-4 rounded-lg border border-blue-200/30 dark:border-blue-500/20 bg-blue-50/50 dark:bg-blue-900/20">
                        <div className="flex items-start gap-2">
                            <InformationCircleIcon className="w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" />
                            <div className="text-xs text-blue-700 dark:text-blue-300">
                                <strong>Tip:</strong> Costs appear within seconds after your scenario runs. If you don't see them, check that your HTTP Request module completed successfully in Make.
                            </div>
                        </div>
                    </div>
                </div>
