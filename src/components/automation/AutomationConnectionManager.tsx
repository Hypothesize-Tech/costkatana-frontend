    ...
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="btn btn-primary flex-1 px-4 py-2 rounded-xl"
              >
      ...
      {connections.length === 0 ? (
        <div className="glass rounded-xl border border-primary-200/30 dark:border-primary-500/20 shadow-lg backdrop-blur-xl p-12 text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#06ec9e]/20 to-[#009454]/20 dark:from-[#06ec9e]/30 dark:to-[#009454]/30 mx-auto mb-4 flex items-center justify-center">
            <BoltIcon className="w-8 h-8 text-[#06ec9e] dark:text-emerald-400" />
          </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3 flex-1">
                  <div className={`w-10 h-10 rounded-lg bg-gradient-to-r ${getPlatformColor(connection.platform)} flex items-center justify-center`}>
                    <BoltIcon className="w-5 h-5 text-white" />
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-body text-light-text-secondary dark:text-dark-text-secondary capitalize">
                      {connection.platform}
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 rounded-lg text-light-text-secondary dark:text-dark-text-secondary hover:text-[#06ec9e] dark:hover:text-emerald-400 hover:bg-[#06ec9e]/10 dark:hover:bg-emerald-400/20 transition-all"
                  >
                    <PencilIcon className="w-5 h-5" />
                  </button>
                  <button
                    onClick={() => handleDelete(connection.id)}
                    className="p-2 rounded-lg text-light-text-secondary dark:text-dark-text-secondary hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all"
                  >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="p-3 rounded-lg border border-primary-200/20 dark:border-primary-500/10">
                  ...
                  <div className="text-sm font-display font-bold gradient-text-primary">
                ...
                <div className="p-3 rounded-lg border border-primary-200/20 dark:border-primary-500/10">
                  ...
                  <div className="text-sm font-display font-bold text-light-text-primary dark:text-dark-text-primary">
