...
import { trainingService, ScoreRequestData } from '../../services/training.service';
...
const TRAINING_TAGS = [
    'concise', 'accurate', 'efficient', 'creative', 'helpful', 'clear', 'complete'
];
        ...
        <div className={`${classes.container}`}>
            ...
            <div className="flex items-center space-x-1">
                {[1, 2, 3, 4, 5].map((star) => (
                    <button
                        ...
                        className={`transition-colors ${star <= score
            ...
            {isExpanded && score > 0 && (
                <div className={`border-t pt-3 ${classes.container}`}>
                    ...
                    {showTags && (
                        <div>
                            <label className={`block font-medium text-gray-700 mb-2 ${classes.text}`}>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {TRAINING_TAGS.map(tag => (
                                    <button
                                        ...
                                        className={`px-2 py-1 rounded-full text-xs font-medium transition-colors ${selectedTags.includes(tag)
