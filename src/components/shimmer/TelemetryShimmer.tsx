      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="p-1 rounded-lg border shadow-lg backdrop-blur-xl glass border-primary-200/30">
          <div className="flex gap-1">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="w-12 h-8 rounded-md skeleton" />
            ))}
          </div>
        </div>
      </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-primary-200/30">
              <th className="px-4 py-3"><div className="w-24 h-4 rounded skeleton" /></th>
              <th className="px-4 py-3"><div className="w-16 h-4 rounded skeleton" /></th>
              <th className="px-4 py-3"><div className="w-32 h-4 rounded skeleton" /></th>
              <th className="px-4 py-3"><div className="w-20 h-4 rounded skeleton" /></th>
            </tr>
          </thead>
          <tbody>
            {[1, 2, 3, 4, 5].map((i) => (
              <tr key={i} className="border-b border-primary-200/20">
                <td className="px-4 py-3"><div className="w-40 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-16 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-20 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-16 h-4 rounded skeleton" /></td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tbody>
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <tr key={i} className="border-b border-primary-200/20">
                <td className="px-4 py-3"><div className="w-32 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-24 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-32 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-16 h-6 rounded-full skeleton" /></td>
                <td className="px-4 py-3"><div className="w-16 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-20 h-4 rounded skeleton" /></td>
                <td className="px-4 py-3"><div className="w-28 h-4 rounded skeleton" /></td>
              </tr>
            ))}
          </tbody>
        </table>
    ...
    <div className="p-6 rounded-xl border shadow-xl backdrop-blur-xl glass border-primary-200/30 dark:border-primary-500/20 bg-gradient-light-panel dark:bg-gradient-dark-panel">
      <div className="flex gap-2 items-center mb-4">
        <div className="flex justify-center items-center w-6 h-6 rounded-lg bg-gradient-primary/20">
          <SparklesIcon className="w-4 h-4 text-primary-500/50" />
        </div>
        <div className="w-40 h-6 rounded skeleton" />
      </div>
...
const ShimmerRecommendationCard: React.FC = () => {
  return (
    <div className="p-4 rounded-lg border-l-4 shadow-lg backdrop-blur-xl glass border-primary-500">
      ...
      <div className="mb-3 w-full h-4 rounded skeleton" />
  ...
  return (
    <div className="p-3 bg-gradient-to-r rounded-lg border-l-4 shadow-lg backdrop-blur-xl glass border-primary-500 dark:border-primary-400 from-primary-50/30 to-primary-100/30 dark:from-primary-900/20 dark:to-primary-800/20">
      <div className="flex flex-wrap gap-2 justify-between items-start">
        <div className="flex-1">
          <div className="mb-1 w-40 h-5 rounded skeleton" />
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          <div className="flex-1">
            <div className="relative">
              <div className="w-full h-11 pl-12 rounded skeleton" />
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="md:col-span-2">
          ...
          <div className="max-h-[500px] overflow-y-auto glass rounded-xl p-4 border border-primary-200/30 shadow-lg backdrop-blur-xl">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="p-4 mb-4 rounded-lg border glass border-primary-200/30">
...
const ShimmerServiceDependencyGraph: React.FC = () => {
  return (
    <div className="p-8 rounded-xl border shadow-xl backdrop-blur-xl glass border-secondary-200/30 bg-gradient-light-panel dark:bg-gradient-dark-panel">
      ...
      <div className="w-full h-[500px] glass rounded-xl border border-primary-200/30 shadow-lg backdrop-blur-xl skeleton" />
    </div>
  );
};
    ...
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-xl border shadow-xl backdrop-blur-xl glass border-primary-200/30 dark:border-primary-500/20 bg-gradient-light-panel dark:bg-gradient-dark-panel">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex-1">
            <div className="mb-2 w-64 h-8 rounded skeleton" />
            <div className="w-full h-4 rounded skeleton" />
          </div>
          <div className="w-32 h-11 rounded-xl skeleton" />
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="rounded-xl border shadow-xl backdrop-blur-xl glass border-primary-200/30 bg-gradient-light-panel dark:bg-gradient-dark-panel">
            <div className="p-6 border-b border-primary-200/20">
        ...
        <div className="p-8 rounded-xl border shadow-xl backdrop-blur-xl glass border-primary-200/30 bg-gradient-light-panel dark:bg-gradient-dark-panel">
          <div className="flex gap-3 items-center mb-2">
            <div className="flex justify-center items-center w-10 h-10 rounded-xl shadow-lg bg-gradient-primary/20">
              <SparklesIcon className="w-6 h-6 text-primary-500/50" />
            </div>
            <div className="w-64 h-9 rounded skeleton" />
          </div>
          <div className="mb-4 w-96 h-4 rounded skeleton" />
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="w-28 h-11 rounded-xl skeleton" />
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="p-4 rounded-xl border shadow-xl backdrop-blur-xl glass border-primary-200/30 bg-gradient-light-panel dark:bg-gradient-dark-panel">
                <div className="flex justify-between items-center">
                  <div className="flex-1">
                    <div className="mb-2 w-28 h-4 rounded skeleton" />
                    <div className="mb-1 w-24 h-8 rounded skeleton" />
