    ...
    const cards = [
        {
            ...
            subValue: `${formatCurrency(stats.currentMonthSpent)} this month`,
        ...
        },
        {
            ...
            subValue: `${formatCurrency(stats.currentMonthSaved)} this month`,
            icon: SparklesIcon,
            color: 'bg-green-500',
        },
        {
        ...
        },
        {
            ...
            subValue: `${((stats.totalSaved / stats.totalSpent) * 100).toFixed(1)}% savings rate`,
            icon: ClockIcon,
            color: 'bg-indigo-500',
        },
    ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="col-span-full grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-lg font-semibold text-gray-900 capitalize">{stats.mostUsedService}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-sm font-medium text-gray-600">Most Used Model</p>
                    <p className="text-lg font-semibold text-gray-900">{stats.mostUsedModel}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-sm font-medium text-gray-600">Account Age</p>
                    <p className="text-lg font-semibold text-gray-900">{stats.accountAge} days</p>
                </div>
            </div>
        </div>
    );
