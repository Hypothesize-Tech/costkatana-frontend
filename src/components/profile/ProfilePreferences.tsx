    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {(['light', 'dark', 'system'] as const).map((theme) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 text-sm font-medium rounded-md border ${localPreferences.theme === theme
                ...
                {/* Email Preferences */}
                <div>
                    <h3 className="text-sm font-medium text-gray-700 mb-4">Email Preferences</h3>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Switch
                            ...
                            onChange={(checked) => handleChange('enableBetaFeatures', checked)}
