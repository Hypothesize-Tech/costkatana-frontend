...
export const EditTemplateModal: React.FC<EditTemplateModalProps> = ({
    ...
    useEffect(() => {
        const hasChanged =
            ...
            JSON.stringify(formData.metadata.tags) !== JSON.stringify(template.metadata.tags || []) ||
            ...
            formData.metadata.recommendedModel !== (template.metadata.recommendedModel || '') ||
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => handleNestedInputChange(['metadata', 'language'], e.target.value)}
                                    className="px-3 py-2 w-full rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleNestedInputChange(['metadata', 'estimatedTokens'], e.target.value ? parseInt(e.target.value) : undefined)}
                                    className="px-3 py-2 w-full rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                    placeholder="e.g., 100"
                                    min="1"
                                />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleNestedInputChange(['metadata', 'recommendedModel'], e.target.value)}
                                className="px-3 py-2 w-full rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
