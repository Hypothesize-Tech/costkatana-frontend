 ...
 */
export const formatSmartNumber = (num: number | null | undefined): string => {
...
export const formatModelName = (model: string): string => {
    const modelMap: { [key: string]: string } = {
        ...
        'anthropic.claude-3-5-haiku-20241022-v2': 'Claude 3.5 Haiku',
        'anthropic.claude-3-5-haiku-20241022-v2:0': 'Claude 3.5 Haiku',
        'mistral.mistral-large-3': 'Mistral Large 3',
        'mistral.mistral-large-3-v1:0': 'Mistral Large 3',
