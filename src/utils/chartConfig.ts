...
export const getLineChartOptions = (options?: Partial<ChartOptions<'line'>>): ChartOptions<'line'> => ({
    ...defaultChartOptions,
    scales: {
        x: {
            grid: {
...
export const getBarChartOptions = (options?: Partial<ChartOptions<'bar'>>): ChartOptions<'bar'> => ({
    ...defaultChartOptions,
    scales: {
        x: {
            grid: {
...
export const getDoughnutChartOptions = (options?: Partial<ChartOptions<'doughnut'>>): ChartOptions<'doughnut'> => ({
    ...defaultChartOptions,
    cutout: '70%',
    plugins: {
...
export const generateDoughnutChartData = (
    ...
    datasets: [{
        data,
        backgroundColor: colors || Object.values(CHART_COLORS).slice(0, data.length),
        borderWidth: 0,
        hoverOffset: 4,
    }],
});
...
export const getChartHeight = (type: 'small' | 'medium' | 'large' = 'medium'): number => {
    const heights = {
        small: 200,
        medium: 300,
        large: 400,
