...
class UploadService {
    async uploadUsageFile(file: File, options?: {
        service?: string;
    ...
    async uploadOptimizationFile(file: File, options?: {
        format?: 'csv' | 'json';
        hasHeaders?: boolean;
    }): Promise<{
        success: boolean;
    ...
    async validateFile(file: File, type: 'usage' | 'optimization'): Promise<{
        success: boolean;
        data: {
            valid: boolean;
            format: string;
    ...
    async downloadTemplate(type: 'usage' | 'optimization', format: 'csv' | 'xlsx' = 'csv'): Promise<Blob> {
