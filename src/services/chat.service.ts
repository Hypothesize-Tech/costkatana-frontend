...
export class ChatService {
    ...
    static async createConversation(request: {
        ...
        try {
            const response = await apiClient.post(`${this.baseUrl}/conversations`, request);
    ...
    static async getConversationHistory(
        ...
        try {
            ...
            return {
                ...
                total: data.total,
                conversation: data.conversation ? this.normalizeConversation(data.conversation) : null
            };
        } catch (error) {
