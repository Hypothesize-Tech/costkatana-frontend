...
type SetupModal = 'slack' | 'discord' | 'webhook' | null;
...
export const IntegrationsPage: React.FC = () => {
    ...
    React.useEffect(() => {
        console.log('IntegrationsPage State:', { isLoading, error, integrations, integrationsData });
    }, [isLoading, error, integrations, integrationsData]);
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <p className="text-secondary-600 dark:text-secondary-300">
                                Connect Cost Katana with Slack, Discord, and custom webhooks to receive real-time alerts
                            </p>
                        </div>
                        <button
