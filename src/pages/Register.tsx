                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary-600 to-primary-800 dark:from-primary-700 dark:to-primary-900">
                    ...
                    <div className="flex absolute inset-0 justify-center items-center p-12">
                        <div className="max-w-xl text-white">
                            ...
                            <div className="p-6 mb-8 rounded-lg backdrop-blur-sm bg-white/10 dark:bg-white/5">
                                <h3 className="mb-4 text-xl font-semibold">Free Plan Includes:</h3>
                                <ul className="space-y-3">
                                    <li className="flex gap-2 items-center">
                                        <svg className="w-5 h-5 text-primary-300 dark:text-primary-200" fill="currentColor" viewBox="0 0 20 20">
