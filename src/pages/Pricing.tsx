        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-1">
            <button
              ...
              className={`px-6 py-4 font-semibold transition-all border-b-2 ${activeTab === 'subscription'
            ...
            <button
              ...
              className={`px-6 py-4 font-semibold transition-all border-b-2 ${activeTab === 'model-pricing'
                ? 'border-primary-500 text-primary-500'
                : 'border-transparent text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text dark:hover:text-dark-text'
                }`}
            >
